...
%   \begin{list}{$\cdot$}{\leftmargin=0em} % \cdot used for bullets, no indentation
%     \itemsep -0.5em \vspace{-0.3em} % Compress items in list together for aesthetics
%     \item \href{http://belov.by}{Blog}
%     \item \href{https://github.com/AlexBelov}{Github profile}
%     \item \href{https://www.linkedin.com/in/belovalexander}{LinkedIn profile}
%     \item \href{https://www.facebook.com/lexbelov}{Facebook profile}
%   \end{list}
% \end{rSection}
